...
Question = function(questionNumber, questionText, answer1, answer2, answer3, answer4, lang, id, codesnippet) {
  ...
  answers[3]="<input type='radio' name='"+ qId +"' value='d' id='q"+qId+"d' style='margin-right: 15px' onclick='checkAnswer(this)' /><label id='q"+qId+"d_lbl' for='q"+qId+"d' style='padding:2px;display:inline;' class='shake'>" + answer4 + "</label><span class='feedback-text' style ='display:none; color:red; padding-left:10px; font-size:smaller;'> Try Again! </span><br/>"
