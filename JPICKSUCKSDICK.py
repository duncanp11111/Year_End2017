...
def draw_car(screen, x, y):
    pygame.draw.circle(screen, BLACK, (300 + x, 300 + y), 20, 0)
    pygame.draw.circle(screen, BLACK, (350 + x, 300 + y), 20, 0)
    pygame.draw.rect(screen, RED, (275 + x, 255 +  y, 100, 30))
    pygame.draw.line(screen, RED, (370 + x, 275 + y), (335 + x, 225 + y), 4)
